...
/**
 * <code>Texture</code> represent a texture that contains one or more {@link Image}(s).
 * <p>
 * A texture can be used as the source of a texture access from a pipeline, or it can be used as a render target.
 *
 * @author Agustin L. Alvarez (wolftein1@gmail.com)
 */
public abstract class Texture extends GLComponent {
    public final static int CONCEPT_FILTER = (1 << 1);
    public final static int CONCEPT_CLAMP_X = (1 << 2);
    public final static int CONCEPT_CLAMP_Y = (1 << 3);
    public final static int CONCEPT_CLAMP_Z = (1 << 4);
    public final static int CONCEPT_IMAGE = (1 << 5);
