...
/**
 * <code>BufferMode</code> enumerates {@link Buffer} mode(s).
 *
...
public enum BufferMode {
    ...
    /**
     * The data store contents are copy between buffers repeatedly.
     * <p>
     * {@since OpenGL 1.5}
     */
    ...
    /**
     * The data store contents are copy between buffers once.
     * <p>
     * {@since OpenGL 1.5}
     */
    ...
    /**
     * The data store contents are copy between buffers frequently.
     * <p>
     * {@since OpenGL 1.5}
     */
     ...
     * <p>Constructor</p>
     */
    BufferMode(int value, boolean readable, boolean writable) {
        eValue = value;
        eReadable = readable;
        eWritable = writable;
    }
