...
/**
 * Quaternions extend a rotation in three dimensions to a rotation in four dimensions.
 * <p/>
 * Quaternions are defined by four floating point component: {x y z w}.
 *
...
public abstract class Quaternionf {
    ...
    public final boolean equals(Object quaternion) {
        if (!(quaternion instanceof Quaternionf) || this != quaternion) {
            return false;
        }
