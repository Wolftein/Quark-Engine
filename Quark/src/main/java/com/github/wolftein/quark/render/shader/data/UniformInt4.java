...
import com.github.wolftein.quark.mathematic.MutableVector4i;
import com.github.wolftein.quark.mathematic.Vector4i;
import com.github.wolftein.quark.render.shader.Uniform;

/**
 * <code>UniformInt4</code> encapsulate an {@link Uniform} for {@link UniformType#Int4}.
 */
public final class UniformInt4 extends Uniform {
    private final MutableVector4i mValue = MutableVector4i.zero();

    /**
     * <p>Default constructor</p>
     */
    public UniformInt4(Vector4i value) {
        super(UniformType.Int4);
        setValue(value);
    }
