...
import ar.com.quark.graphic.texture.Texture2D;
...
public final class TexturePNGAssetLoader implements AssetLoader<Texture, Texture.Descriptor> {
    ...
    private Image readImage(Texture.Descriptor descriptor, ImageHeader header, byte[] input) throws IOException {
        ...
        final Int8Buffer imageBuffer
                = BufferFactory.allocateInt8(header.mImageWidth * header.mImageHeight * imageFormat.eComponent);
     ...
     * @throws IOException indicates failing loading the image
     */
    private void handleData(ImageHeader header, byte[] input, Int8Buffer output) throws IOException {
