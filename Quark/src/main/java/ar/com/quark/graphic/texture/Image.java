...
public final class Image {
    private final ImmutableList<Layer> mLayer;
     ...
     * <p>Constructor</p>
     */
    public Image(ImageFormat format, int width, int height, int depth, ImmutableList<Layer> data) {
        mFormat = format;
        mWidth = width;
        mHeight = height;
        mDepth = depth;
    ...
    public Image(ImageFormat format, int width, int height, int depth, Layer data) {
        this(format, width, height, depth, Lists.immutable.of(data));
    }
     ...
     */
    public ImmutableList<Layer> getLayer() {
        return mLayer;
    }
    ...
    public final static class Layer {
         ...
         * <p>Constructor</p>
         */
        public Layer(Int8Buffer data, int[] images) {
            this.data = data;
            this.images = images;
            this.mipmap = false;
        }
         ...
         * <p>Constructor</p>
         */
        public Layer(Int8Buffer data, boolean mipmap) {
            this.data = data;
         ...
         */
        public void delete() {
            data = BufferFactory.deallocate(data);
        }
