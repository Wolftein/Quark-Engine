...
import ar.com.quark.graphic.storage.Primitive;
import ar.com.quark.graphic.storage.Storage;
import ar.com.quark.graphic.storage.VertexDescriptor;
import ar.com.quark.graphic.storage.VertexFormat;
import ar.com.quark.graphic.texture.Texture;
import ar.com.quark.graphic.texture.frame.Frame;
import ar.com.quark.utility.ManageableFactory;
import ar.com.quark.utility.buffer.*;

/**
 * <code>Render</code> encapsulate the render module.
 */
public interface Graphic extends ManageableFactory {
    /**
    ...
    interface GLES2 extends GLESExtension {
        ...
        GraphicCapabilities glCapabilities();
        ...
        void glBufferData(int target, Int8Buffer data, int usage);

        void glBufferData(int target, Int16Buffer data, int usage);

        void glBufferData(int target, Int32Buffer data, int usage);

        void glBufferData(int target, UnsignedInt8Buffer data, int usage);

        void glBufferData(int target, UnsignedInt16Buffer data, int usage);

        void glBufferData(int target, UnsignedInt32Buffer data, int usage);

        void glBufferData(int target, Float16Buffer data, int usage);

        void glBufferData(int target, Float32Buffer data, int usage);

        void glBufferSubData(int target, int offset, Int8Buffer data);

        void glBufferSubData(int target, int offset, Int16Buffer data);

        void glBufferSubData(int target, int offset, Int32Buffer data);

        void glBufferSubData(int target, int offset, UnsignedInt8Buffer data);

        void glBufferSubData(int target, int offset, UnsignedInt16Buffer data);

        void glBufferSubData(int target, int offset, UnsignedInt32Buffer data);

        void glBufferSubData(int target, int offset, Float16Buffer data);

        void glBufferSubData(int target, int offset, Float32Buffer data);

        void glUnmapBuffer(int target);

        <T extends Buffer<?>> T glMapBuffer(int target, int access, int format);
        ...
        void glUniform1fv(int name, Float32Buffer buffer);
        ...
        void glUniform1iv(int name, Int32Buffer buffer);

        void glUniformMatrix3fv(int name, boolean transpose, Float32Buffer buffer);

        void glUniformMatrix4fv(int name, boolean transpose, Float32Buffer buffer);
    }
    ...
    interface GLES3 extends GLES2 {
        ...
        <T extends Buffer<?>> T glMapBufferRange(int target, int offset, int size, int access, int format);
        ...
        void glUniform1uiv(int name, UnsignedInt32Buffer buffer);
    }
     ...
     */
    GraphicCapabilities getCapabilities();
     ...
     */
    void apply(GraphicState states);
     ...
     * @see #unmap(Storage)
     */
    <T extends Buffer<?>> T map(Storage<T> storage, int offset, int length);
     ...
     * @see #unmap(Storage)
     */
    <T extends Buffer<?>> T map(Storage<T> storage, int access, int offset, int length);
