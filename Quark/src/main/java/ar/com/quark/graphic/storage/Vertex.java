...
public final class Vertex {
    ...
    /**
     * <code>Builder</code> builder pattern for a collection of {@link Vertex}.
     */
    public final static class Builder {
        private final MutableList<Vertex> mCollection = Lists.mutable.empty();
         ...
         */
        public ImmutableList<Vertex> build() {
            return mCollection.toImmutable();
        }
    }
}
