...
import ar.com.quark.mathematic.MutableVector4i;
import ar.com.quark.mathematic.Vector2f;
import ar.com.quark.mathematic.Vector4i;

/**
 * <code>RenderState</code> contain(s) all render state(s) of {@link Graphic}.
 */
public final class GraphicState {
    ...
    public enum Blend {
         ...
         * Turn off.
         */
        NONE(Graphic.GLES2.GL_NONE, Graphic.GLES2.GL_NONE),

        /**
         * Inherit.
         */
        INHERIT(Graphic.GLES2.GL_NONE, Graphic.GLES2.GL_NONE),

        /**
         * Result = source_colour + destination_colour.
         */
        ADD(Graphic.GLES2.GL_ONE, Graphic.GLES2.GL_ONE),

        /**
         * Result = source_colour * destination_colour.
         */
        MULTIPLY(Graphic.GLES2.GL_DST_COLOR, Graphic.GLES2.GL_ZERO),

        /**
         * Result = source_colour * destination_colour * 2.
         */
        MULTIPLY_TWICE(Graphic.GLES2.GL_DST_COLOR, Graphic.GLES2.GL_SRC_COLOR),

        /**
         * Result = source_alpha * source_colour + (1 - source_alpha) * destination_colour.
         */
        ALPHA(Graphic.GLES2.GL_SRC_ALPHA, Graphic.GLES2.GL_ONE_MINUS_SRC_ALPHA),

        /**
         * Result = (source_alpha * source_colour) + destination_colour.
         */
        ALPHA_ADD(Graphic.GLES2.GL_SRC_ALPHA, Graphic.GLES2.GL_ONE),

        /**
         * Result = source_colour + (destination_colour * 1 - source_alpha).
         */
        ALPHA_PRE_MULTIPLY(Graphic.GLES2.GL_ONE, Graphic.GLES2.GL_ONE_MINUS_SRC_ALPHA),

        /**
         * Result = source_colour + (1 - source_colour) * destination_colour.
         */
        COLOR(Graphic.GLES2.GL_ONE, Graphic.GLES2.GL_ONE_MINUS_SRC_COLOR),

        /**
         * Result = (source_colour * (1 - destination_colour)) + (destination_colour * (1 - source_colour)).
         */
        COLOR_EXCLUSION(Graphic.GLES2.GL_ONE_MINUS_DST_COLOR, Graphic.GLES2.GL_ONE_MINUS_SRC_COLOR);
    ...
    public enum BlendEquation {
         ...
         */
        ADD(Graphic.GLES2.GL_FUNC_ADD),

        /**
         * Result = source_rgba - destination_rgba.
         */
        SUBTRACT(Graphic.GLES2.GL_FUNC_SUBTRACT),

        /**
         * Result = destination_rgba - source_rgba.
         */
        SUBTRACT_REVERSE(Graphic.GLES2.GL_FUNC_REVERSE_SUBTRACT),

        /**
         * Result = min(source_rgba, destination_rgba).
         */
        MIN(Graphic.GLES3.GL_MIN),

        /**
         * Result = max(source_rgba, destination_rgba).
         */
        MAX(Graphic.GLES3.GL_MAX);
    ...
    public enum Cull {
         ...
         * Turn off.
         */
        NONE(Graphic.GLES2.GL_NONE),

        /**
         * Inherit.
         */
        INHERIT(Graphic.GLES2.GL_NONE),

        /**
         * Cull only front-face.
         */
        FRONT(Graphic.GLES2.GL_FRONT),

        /**
         * Cull front- and back- face.
         */
        FRONT_BACK(Graphic.GLES2.GL_FRONT_BACK),

        /**
         * Cull only back-face.
         */
        BACK(Graphic.GLES2.GL_BACK);
    ...
    public enum StencilOp {
         ...
         */
        KEEP(Graphic.GLES2.GL_KEEP),

        /**
         * Sets the stencil buffer value to 0.
         */
        ZERO(Graphic.GLES2.GL_ZERO),

        /**
         * Replace the stencil buffer value.
         */
        REPLACE(Graphic.GLES2.GL_REPLACE),

        /**
         * Increments the current stencil buffer value. Clamps to the maximum representable unsigned value.
         */
        INCREMENT(Graphic.GLES2.GL_INCREMENT),

        /**
         * Increments the current stencil buffer value. Wraps stencil buffer value to zero when incrementing
         * the maximum representable unsigned value.
         */
        INCREMENT_WRAP(Graphic.GLES2.GL_INCREMENT_WRAP),

        /**
         * Decrements the current stencil buffer value. Clamps to 0.
         */
        DECREASE(Graphic.GLES2.GL_DECREASE),

        /**
         * Decrements the current stencil buffer value. Wraps stencil buffer value to the maximum representable
         * unsigned value when decrementing a stencil buffer value of zero.
         */
        DECREASE_WRAP(Graphic.GLES2.GL_DECREASE_WRAP),

        /**
         * Bitwise inverts the current stencil buffer value.
         */
        INVERT(Graphic.GLES2.GL_INVERT);
    ...
    public enum TestOp {
         ...
         * Always fails.
         */
        NEVER(Graphic.GLES2.GL_NEVER),

        /**
         * Always passes.
         */
        ALWAYS(Graphic.GLES2.GL_ALWAYS),

        /**
         * Passes if reference is less than mask.
         */
        LESS(Graphic.GLES2.GL_LESS),

        /**
         * Passes if reference is less or equal than mask.
         */
        LESS_EQUAL(Graphic.GLES2.GL_LESS_EQUAL),

        /**
         * Passes if reference is greater than mask.
         */
        GREATER(Graphic.GLES2.GL_GREATER),

        /**
         * Passes iif reference is greater or equal than mask.
         */
        GREATER_EQUAL(Graphic.GLES2.GL_GREATER_EQUAL),

        /**
         * Passes if reference is equal than mask.
         */
        EQUAL(Graphic.GLES2.GL_EQUAL),

        /**
         * Passes if reference is not equal than mask.
         */
        NOT_EQUAL(Graphic.GLES2.GL_NOT_EQUAL);
     ...
     */
    public void merge(GraphicState other) {
     ...
     */
    public GraphicState setAlphaToCoverage(Flag flag) {
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setBlend(Blend blend) {
        mBlend = blend;
        return this;
    }
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setBlendEquation(BlendEquation op) {
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setBlendEquation(BlendEquation colour, BlendEquation alpha) {
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setColourMask(Flag mask) {
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setColourMask(Flag red, Flag green, Flag blue, Flag alpha) {
        mRedMask = red;
        mGreenMask = green;
        mBlueMask = blue;
        mAlphaMask = alpha;
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setCullFace(Cull op) {
        mCull = op;
        return this;
    }
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setDepth(Flag flag) {
        mDepth = flag;
        return this;
    }
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setDepthMask(Flag flag) {
        mDepthMask = flag;
        return this;
    }
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setDepthRange(Vector2f range) {
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setDepthRange(float near, float far) {
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setDepthOp(TestOp op) {
        mDepthOp = op;
        return this;
    }
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setScissor(Flag flag) {
        mScissor = flag;
        return this;
    }
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setScissorViewport(int x1, int y1, int x2, int y2) {
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setStencil(Flag flag) {
        mStencil = flag;
        return this;
    }
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setStencilOp(TestOp op) {
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setStencilOp(TestOp front, TestOp back) {
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setStencilFrontOp(StencilOp op) {
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setStencilFrontOp(StencilOp sfail, StencilOp dfail, StencilOp dpass) {
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setStencilBackOp(StencilOp op) {
     ...
     * @return <code>this</code> for chain operation(s)
     */
    public GraphicState setStencilBackOp(StencilOp sfail, StencilOp dfail, StencilOp dpass) {
