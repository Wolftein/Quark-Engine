...
public enum VertexFormat {
     ...
     */
    BYTE(Graphic.GLES2.GL_BYTE, 0x01),

    /**
     * Represent an unsigned 8-bit integer.
     */
    UNSIGNED_BYTE(Graphic.GLES2.GL_UNSIGNED_BYTE, 0x01),

    /**
     * Represent a signed 16-bit integer.
     */
    SHORT(Graphic.GLES2.GL_SHORT, 0x02),

    /**
     * Represent an unsigned 16-bit integer.
     */
    UNSIGNED_SHORT(Graphic.GLES2.GL_UNSIGNED_SHORT, 0x02),

    /**
     * Represent a signed 32-bit integer.
     */
    INT(Graphic.GLES3.GL_INT, 0x04),

    /**
     * Represent an unsigned 32-bit integer.
     */
    UNSIGNED_INT(Graphic.GLES3.GL_UNSIGNED_INT, 0x04),

    /**
     * Represent a IEEE-754 single-precision floating point number.
     */
    FLOAT(Graphic.GLES2.GL_FLOAT, 0x04),

    /**
     * Represent a IEEE-754 half-precision floating point number.
     */
    HALF_FLOAT(Graphic.GLES3.GL_HALF_FLOAT, 0x02);
