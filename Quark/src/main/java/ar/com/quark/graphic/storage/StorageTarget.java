...
public enum StorageTarget {
     ...
     */
    ARRAY(Graphic.GLES2.GL_ARRAY_BUFFER),

    /**
     * Represent a storage for indices.
     */
    ELEMENT(Graphic.GLES2.GL_ELEMENT_ARRAY_BUFFER),

    /**
     * Represent a storage for pixel data being sent to the GPU.
     */
    PIXEL_PACK(Graphic.GLES3.GL_PIXEL_PACK_BUFFER),

    /**
     * Represent a storage for pixel data being read to the GPU.
     */
    PIXEL_UNPACK(Graphic.GLES3.GL_PIXEL_UNPACK_BUFFER),

    /**
     * Represent a storage for results from executing a transform feedback shader.
     */
    TRANSFORM_FEEDBACK(Graphic.GLES3.GL_TRANSFORM_FEEDBACK_BUFFER),

    /**
     * Represent a storage for data copied between storage.
     */
    COPY_READ(Graphic.GLES3.GL_COPY_READ_BUFFER),

    /**
     * Represent a storage for data copied between storage.
     */
    COPY_WRITE(Graphic.GLES3.GL_COPY_WRITE_BUFFER),

    /**
     * Represent a storage for data(s).
     */
    UNIFORM(Graphic.GLES3.GL_UNIFORM_BUFFER),

    /**
     * Represent a storage for texture(s).
     */
    TEXTURE(Graphic.GLES32.GL_TEXTURE_BUFFER);
