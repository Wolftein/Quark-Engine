...
public enum TextureFilter {
     ...
     */
    POINT(Graphic.GLES2.GL_NEAREST, Graphic.GLES2.GL_NEAREST_MIPMAP_NEAREST, Graphic.GLES2.GL_NEAREST, 1),
     ...
     */
    BILINEAR(Graphic.GLES2.GL_LINEAR, Graphic.GLES2.GL_LINEAR_MIPMAP_NEAREST, Graphic.GLES2.GL_LINEAR, 1),
     ...
     */
    TRILINEAR(Graphic.GLES2.GL_LINEAR, Graphic.GLES2.GL_LINEAR_MIPMAP_LINEAR, Graphic.GLES2.GL_LINEAR, 1),

    /**
     * Uses {@link #TRILINEAR} as base filter and additionally applies a 2x anisotropic filter.
     */
    ANISOTROPIC_2(Graphic.GLES2.GL_LINEAR, Graphic.GLES2.GL_LINEAR_MIPMAP_LINEAR, Graphic.GLES2.GL_LINEAR, 2),

    /**
     * Uses {@link #TRILINEAR} as base filter and additionally applies a 4x anisotropic filter.
     */
    ANISOTROPIC_4(Graphic.GLES2.GL_LINEAR, Graphic.GLES2.GL_LINEAR_MIPMAP_LINEAR, Graphic.GLES2.GL_LINEAR, 4),

    /**
     * Uses {@link #TRILINEAR} as base filter and additionally applies a 8x anisotropic filter.
     */
    ANISOTROPIC_8(Graphic.GLES2.GL_LINEAR, Graphic.GLES2.GL_LINEAR_MIPMAP_LINEAR, Graphic.GLES2.GL_LINEAR, 8),

    /**
     * Uses {@link #TRILINEAR} as base filter and additionally applies a 16x anisotropic filter.
     */
    ANISOTROPIC_16(Graphic.GLES2.GL_LINEAR, Graphic.GLES2.GL_LINEAR_MIPMAP_LINEAR, Graphic.GLES2.GL_LINEAR, 16);
