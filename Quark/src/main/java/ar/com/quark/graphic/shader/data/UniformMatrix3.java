...
import ar.com.quark.mathematic.Matrix3f;
import ar.com.quark.mathematic.MutableMatrix3f;
...
public final class UniformMatrix3 extends Uniform {
    private final Float32Buffer mBuffer = BufferFactory.allocateFloat32(3 * 3);
