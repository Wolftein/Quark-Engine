...
public enum StorageMode {
     ...
     */
    DYNAMIC_DRAW(Graphic.GLES2.GL_DYNAMIC_DRAW, false, true),

    /**
     * The data store contents are queried repeatedly.
     */
    DYNAMIC_READ(Graphic.GLES3.GL_DYNAMIC_READ, true, false),

    /**
     * The data store contents are copy between storage repeatedly.
     */
    DYNAMIC_COPY(Graphic.GLES3.GL_DYNAMIC_COPY, false, false),

    /**
     * The data store contents is modified once.
     */
    STATIC_DRAW(Graphic.GLES2.GL_STATIC_DRAW, false, true),

    /**
     * The data store contents is queried once.
     */
    STATIC_READ(Graphic.GLES3.GL_STATIC_READ, true, false),

    /**
     * The data store contents are copy between storage once.
     */
    STATIC_COPY(Graphic.GLES3.GL_STATIC_COPY, false, false),

    /**
     * The data store contents are modified frequently.
     */
    STREAM_DRAW(Graphic.GLES2.GL_STREAM_DRAW, false, true),

    /**
     * The data store contents are queried frequently.
     */
    STREAM_READ(Graphic.GLES3.GL_STREAM_READ, true, false),

    /**
     * The data store contents are copy between storage frequently.
     */
    STREAM_COPY(Graphic.GLES3.GL_STREAM_COPY, false, false);
