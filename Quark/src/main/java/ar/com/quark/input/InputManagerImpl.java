...
/**
 * Implementation for {@link InputManager}.
 */
public final class InputManagerImpl implements InputManager {
    /**
     * Hold all raw input listener of the manager.
     */
    private final MutableSet<InputListener> mListener = Sets.mutable.empty();
     ...
     */
    private final Int32Buffer mBuffer = BufferFactory.allocateInt32(1024);
    ...
    private void onProcessInputEvent() {
        //!
        //! Change the buffer mode to read-mode.
        //!
        mBuffer.flip();
