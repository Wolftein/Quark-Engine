...
/**
 * <a href="http://teavm.org/">TeaVM</a> implementation for {@link Render.GLES3}.
 */
public class TeaVMOpenGLES30 extends TeaVMOpenGLES20 implements Render.GLES3 {
     ...
     * <p>Constructor</p>
     */
    public TeaVMOpenGLES30(HTMLCanvasElement canvas) {
        super(canvas);
    ...
    public interface OES_vertex_array_object extends JSObject {
        String[] NAMES = {
                ...
                "O_OES_vertex_array_object",
                "IE_OES_vertex_array_object",
    ...
    public interface OES_texture_compression_s3tc extends JSObject {
        String[] NAMES = {
                ...
                "O_WEBGL_compressed_texture_s3tc",
                "IE_WEBGL_compressed_texture_s3tc",
    ...
    public interface OES_texture_filter_anisotropic extends JSObject {
        String[] NAMES = {
                ...
                "IE_EXT_texture_filter_anisotropic",
