...
public class WebOpenGLES20 implements Render.GLES2 {
     ...
     */
    @Override
    public void glBufferData(int target, ar.com.quark.system.utility.array.Int8Array data, int usage) {
     ...
     */
    @Override
    public void glBufferData(int target, ar.com.quark.system.utility.array.Int16Array data, int usage) {
        mGL.bufferData(target, data.<ArrayBuffer>data(), usage);
    }
     ...
     */
    @Override
    public void glBufferData(int target, ar.com.quark.system.utility.array.Int32Array data, int usage) {
        mGL.bufferData(target, data.<ArrayBuffer>data(), usage);
    }
     ...
     */
    @Override
    public void glBufferData(int target, ar.com.quark.system.utility.array.Float32Array data, int usage) {
        mGL.bufferData(target, data.<ArrayBuffer>data(), usage);
    }
     ...
     */
    @Override
    public void glBufferSubData(int target, int offset, ar.com.quark.system.utility.array.Int8Array data) {
     ...
     */
    @Override
    public void glBufferSubData(int target, int offset, ar.com.quark.system.utility.array.Int16Array data) {
        mGL.bufferSubData(target, offset, data.<ArrayBuffer>data());
    }
     ...
     */
    @Override
    public void glBufferSubData(int target, int offset, ar.com.quark.system.utility.array.Int32Array data) {
        mGL.bufferSubData(target, offset, data.<ArrayBuffer>data());
    }
     ...
     */
    @Override
    public void glBufferSubData(int target, int offset, ar.com.quark.system.utility.array.Float32Array data) {
        mGL.bufferSubData(target, offset, data.<ArrayBuffer>data());
    }
    ...
    public void glTexImage2D(int target, int level, int internal, int width, int height,
            int border, int format, int type, ar.com.quark.system.utility.array.Int8Array data) {
    ...
    public void glCompressedTexImage2D(int target, int level, int internal, int width, int height,
            int border, ar.com.quark.system.utility.array.Int8Array data) {
     ...
     */
    @Override
    public void glUniform1fv(int name, ar.com.quark.system.utility.array.Float32Array buffer) {
     ...
     */
    @Override
    public void glUniform1iv(int name, ar.com.quark.system.utility.array.Int32Array buffer) {
     ...
     */
    @Override
    public void glUniformMatrix3fv(int name, boolean transpose, ar.com.quark.system.utility.array.Float32Array buffer) {
     ...
     */
    @Override
    public void glUniformMatrix4fv(int name, boolean transpose, ar.com.quark.system.utility.array.Float32Array buffer) {
